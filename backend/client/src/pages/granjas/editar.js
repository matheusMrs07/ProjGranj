...
export default function GranjasCadastrar() {
  ...
  useEffect(() =>{
    ...
    async function loadGranja(){
      ...
      const response = await api.get("/api/granja/"+idGranja);
      setCapacidade(response.data.capacidade);
      setPropriedadeId(response.data.propriedadeId);
    }
  ...
  async function handleSubmit(){
    ...
    const response = await api.put('/api/granja/'+idGranja, data);
