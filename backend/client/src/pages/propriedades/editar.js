...
export default function PropriedadesEditar() {
  ...
  useEffect(() =>{
    ...
    async function getPropriedade(){
      const response = await api.get("api/propriedade/"+idPropriedade);
  ...
  async function handleSubmit(){
    ...
    const response = await api.put('/api/propriedade/'+idPropriedade, data);
